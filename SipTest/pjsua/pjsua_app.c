...
//    if (app_config.auto_answer > 0) {
        ...
        pjsua_call_answer2(call_id, &opt, 200/*app_config.auto_answer*/, NULL,
                           NULL);
//    }
...
static void on_call_media_state(pjsua_call_id call_id)
{
    ...
    if (call_info.rem_offerer && call_info.rem_vid_cnt)
    {
        ...
        if (vid_idx == -1 || call_info.media[vid_idx].dir == PJMEDIA_DIR_NONE) {
            printf("Just rejected incoming video offer on call %d, use \"vid call enable %d\" or \"vid call add\" to enable video!", call_id, vid_idx);
            //            PJ_LOG(3,(THIS_FILE,
...
//#endif
    ...
    app_config.cfg.outbound_proxy[0] = pj_str("sips:siptest.butterflymx.com:5061");
